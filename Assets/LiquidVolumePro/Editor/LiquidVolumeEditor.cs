...
namespace LiquidVolumeFX {
    ...
    public class LiquidVolumeEditor : Editor {
        ...
        SerializedProperty level, levelMultipler, liquidColor1, liquidColor2, liquidScale1, liquidScale2, alpha, finalAlphaMultiplier, emissionColor, emissionBrightness, useLightColor, useLightDirection, directionalLight;
        ...
        SerializedProperty liquidRaySteps, foamRaySteps, fixMesh, pivotOffset, autoCloseMesh, smokeRaySteps, extentsScale, msaaFlaskThicknessCorrection;
        SerializedProperty limitVerticalRange, upperLimit, lowerLimit, noiseVariation, allowViewFromInside;
        ...
        void OnEnable() {
            ...
            msaaFlaskThicknessCorrection = serializedObject.FindProperty("_msaaFlaskThicknessCorrection");
        ...
        public override void OnInspectorGUI() {
            ...
            if (expandSection[ADVANCED_SETTINGS]) {
                ...
                if (topology.intValue == (int)TOPOLOGY.Irregular) {
                    ...
                    EditorGUILayout.PropertyField(msaaFlaskThicknessCorrection, new GUIContent("MSAA Thickness Correction", "When using MSAA and irregular topology, adding a small amount of thickness (ie. 0.01) to the back faces mask can remove outline artifacts."));
